...
//   for (let i = 0; i < Fruta.length; i++) {
    // if(Collision({x:ultimo.x,y:ultimo.y,width:10,height:10},Fruta[i].fruta)){
    //     cortadas++
    //     document.querySelector("h3").innerHTML = cortadas
    //     ShortFruit(Fruta[i].fruta.x,Fruta[i].fruta.y,app,container,Fruta[i].url)
    //     container.removeChild(Fruta[i].fruta)
    //     container.removeChild(Fruta[i].shadow)
    //     DirectionState = ""
